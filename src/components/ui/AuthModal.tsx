        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center">
            ...
            <div className="relative bg-white rounded-2xl shadow-2xl p-8 w-full max-w-sm mx-4">
                ...
                <div className="text-center mb-6">
                    ...
                    <h2 className="text-xl font-bold text-gray-900">{t("authRequired")}</h2>
                    <p className="text-sm text-gray-500 mt-2">{t("authRequiredDesc")}</p>
                </div>
                ...
                <button onClick={onClose} className="w-full mt-4 text-sm text-gray-500 hover:text-gray-700 transition-colors">
                    {t("cancel")}
                </button>
            </div>
        </div>
